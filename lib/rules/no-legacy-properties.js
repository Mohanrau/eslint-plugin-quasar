...
module.exports = {
  meta: {
    ...
    fixable: 'whitespace',  // null or "code" or "whitespace"
    schema: [
      // fill in your schema
    ],
    messages: {
        ...
        if (o !== void 0) {
          ...
          if (attrs.length > 0) {
            ...
            for (let index = 0; index < attrs.length; ++index) {
              let prevAttribute = attrs[index - 1] || false
              let attribute = attrs[index]
              let prevAtt = sourceCode.getText(element)
                ...
                if (props.includes(name)) {
                  reports.push(context.report({
                    ...
                    fix (fixer) {
                      ...
                      problems.push(fixer.replaceTextRange(attribute.range, ' '))
                      return problems
                    }
                  }))
                }
